...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  intro.setOptions({
    ...
    steps: [
      {
        intro: "Welcome to Opus! <br><br> Opus is an artist-exploration data-visualization application, built with the Spotify Web API and D3.js. Our goal is to help you find your next favorite artist! <br><br> Press enter for a tour around.",
        tooltipClass: 'intro',
      },
      {
        element: '#search-step',
        intro: "Let's begin! First, you'll type an artist you like here. <br><br> CAUTION: Audio will begin playing.",
      },
      {
        element: '#node-step',
