...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  intro.setOptions({
    ...
    steps: [
      {
        intro: "Welcome to Opus! <br><br> Opus is an artist-exploration data-visualization application, built with the Spotify Web API and D3.js. Our goal is to help you find your next favorite artist! <br><br> If your browser isn't in fullscreen, please make it fullscreen, refresh this page, and click on the Tour button. <br><br> Press enter for a tour around.<br> Press escape to skip this tutorial.",
        tooltipClass: 'intro',
      },
      {
        element: '#search-step',
